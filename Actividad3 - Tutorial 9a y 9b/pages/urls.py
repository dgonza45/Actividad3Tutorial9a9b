...
from .views import HomePageView, AboutPageView, ContactPageView, ProductIndexView, ProductShowView, ProductCreateView, ProductCreadoView, CartRemoveAllView, CartView, ImageViewFactory, ImageViewNoDI
...
urlpatterns = [
     ...
     path('image_save', ImageViewFactory(ImageLocalStorage()).as_view(), name='image_save'),
